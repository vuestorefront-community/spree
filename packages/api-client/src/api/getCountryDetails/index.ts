import { ApiContext, GetCountryDetailsParams } from '../../types';
import { Country } from '../../types/country';
import { deserializeCountry } from '../serializers/country';

export default async function getCountryDetails({ client }: ApiContext, { iso }: GetCountryDetailsParams): Promise<Country> {
