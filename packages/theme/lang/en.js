...
export default {
  ...
  'Manage saved addresses': 'Manage all the saved addresses you want (work place, home address...) This way you won"t have to enter an address manually with each order.',
  'Quantity': 'Quantity',
  'Price': 'Price',
