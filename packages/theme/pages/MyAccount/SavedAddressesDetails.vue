  ...
  <transition name="fade">
    ...
    <SfTabs
      ...
      <SfTab title="Saved addresses">
        ...
        <transition-group tag="div" name="fade" class="savedAddresses-list">
          <div
            v-for="address in addresses"
            :key="UserShippingGetters.getId(address)"
            class="savedAddresses">
            <div class="savedAddresses__content">
              <div class="savedAddresses__address">
                <UserSavedAddress :address="address" />
              </div>
            </div>
            <div class="savedAddresses__actions">
              <SfIcon
                icon="cross"
                color="gray"
                size="14px"
              ...
              <SfButton
                class="color-light savedAddresses__button-delete desktop-only"
                @click="removeAddress(address)">
                {{ $t('Delete') }}
              </SfButton>
            </div>
